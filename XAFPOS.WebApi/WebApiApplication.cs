...
namespace XAFPOS.WebApi {
    public partial class XAFPOSWebApiApplication : BlazorApplication {
        public XAFPOSWebApiApplication() {
            InitializeComponent();
        }
        ...
        private void XAFPOSWebApiApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
