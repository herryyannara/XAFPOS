...
using XAFPOS.Blazor.Server.Services;
...
namespace XAFPOS.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<XAFPOSBlazorApplication>(Configuration);
            ...
            services.AddSwaggerGen(c => {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "XAFPOS API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the XAFPOS.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
