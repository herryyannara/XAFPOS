...
namespace XAFPOS.Blazor.Server {
    public partial class XAFPOSBlazorApplication : BlazorApplication {
        public XAFPOSBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XAFPOSBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
